...
import { detectPackageManager } from './install.ts'
      ...
      choices: (answers: { framework?: Framework }) => {
        if (answers.framework === 'vue') {
          return [
            ...
            { name: 'Ant Design Vue', value: 'antDesignVue' },
          ]
        }
        return [{ name: 'Ant Design', value: 'antDesign' }]
      },
    },
    {
      type: 'list',
      ...
      choices: [
        { name: 'File-based routing (vite-plugin-pages)', value: 'fileSystem' },
