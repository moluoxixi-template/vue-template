/**
 * Vue pnpm-workspace.yaml 数据配置
 * 用于生成 pnpm-workspace.yaml
 */

import type { PnpmWorkspaceType, ProjectConfigType } from '../../src/types';

/**
 * 获取 Vue pnpm-workspace 配置
 */
export function getVuePnpmWorkspace(config: ProjectConfigType): PnpmWorkspaceType {
